      ...
      <div className="min-h-screen p-6 bg-slate-950 text-slate-100">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-black">Area Seller</h1>
          ...
          <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950/40">
            ...
            <p className="text-sm text-slate-400 mt-2">
              L&apos;area seller è pronta come base (auth + route). I moduli (catalogo, ordini, analytics) verranno
              abilitati progressivamente.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950/40">
              <div className="font-black">Gestione prodotti</div>
              <div className="text-sm text-slate-400 mt-1">In arrivo</div>
            </div>
            <div className="p-5 rounded-2xl border border-slate-800 bg-slate-950/40">
              <div className="font-black">Ordini & vendite</div>
              <div className="text-sm text-slate-400 mt-1">In arrivo</div>
            </div>
          </div>
        </div>
